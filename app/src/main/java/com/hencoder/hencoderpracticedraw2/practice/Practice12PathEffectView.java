...
public class Practice12PathEffectView extends View {
...

    {
        ...
        dashPath.rLineTo(30, -15);
        dashPath.rLineTo(15, 30);
        dashPath.close();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        PathEffect cornerEffect = new CornerPathEffect(20);
        ...
        // 第三处：DashPathEffect
        PathEffect dashPathEffect = new DashPathEffect(new float[]{20, 5, 10, 5}, 5);
        ...
        PathEffect pathDashPathEffect = new PathDashPathEffect(dashPath, 40, 0, PathDashPathEffect.Style.TRANSLATE);
